    ...
    <div class="mt-5">
        <div class="card border-0 shadow rounded">
            <div class="card-body">
                ...
                <br>
                <div class="card-title h2 text-capitalize text-center">List Of All Regular Expanse From Site</div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.expanse.create')}}" id="form" method="post">
                            <div class="">
