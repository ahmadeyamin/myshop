    ...
    <div class="mt-5">
        <div class="card border-0 shadow rounded">
            <div class="card-body">
                ...
                <br>
                <div class="card-title h2 text-capitalize text-center">List Of All Irregular Income From Site</div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.irrincome.create')}}" v-on:submit="formsubmit()" id="form" method="post">
                            <div>
                            ...
                            <div>
                                <input type="checkbox" id="qty_check" name="qty_check" v-model="form_qty_check" checked switch="bool"/>
                            ...
                            <div class="form-group my-1">
                                ...
                                <input :disabled="!form_qty_check" type="number" value="1"  name="qty" id="qty" class="form-control rounded">
...
<script>
    $(function () {
        $('#orders-table').DataTable({
            ...
            serverSide: true,
            order:  [0, 'desc'] ,
            ajax: "{{route('ajax.get_irrincomes')}}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
