    ...
    <div class="">
        ...
        <div class="card  border-0 shadow rounded">
            <div class="card-body ">
                ...
                <h1 class=" h1 text-capitalize text-center">Edit Expanse</h1>
                <hr>
                <br>
                <div class="row">
                    <div class="col-sm-12 col-md-8 m-auto">
                        <form action="{{route('admin.expanse.edit',$data->id)}}" id="form" method="post">
                            <div class="">
                            ...
                            <div class="form-group" v-if="form_check">
                                <label for="name">Title Of Expanse<span class="text-danger">*</span></label>
                            ...
                            <div class="form-group my-5">
                                <label for="fstatus">Expanse Status<span class="text-danger">*</span></label>
