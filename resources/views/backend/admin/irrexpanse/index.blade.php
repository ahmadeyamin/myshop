    ...
    <div class="mt-5">
        <div class="card border-0 shadow rounded">
            <div class="card-body">
                ...
                <br>
                <div class="card-title h2 text-capitalize text-center">List Of All IrrRegular Expanse From Site</div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="mt-0 text-center d-block" id="myLargeModalLabel">Add Expanse Information</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <form action="{{route('admin.irrexpanse.create')}}" id="form" method="post">
                            <div class="">
...
<script>
    $(function () {
        $('#orders-table').DataTable({
            ...
            serverSide: true,
            order:  [0, 'desc'] ,
            ajax: "{{route('ajax.get_irrexpanse')}}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
