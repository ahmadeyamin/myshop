    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="@if(request()->routeIs('home')) active mm-active  @endif">
                ...
                <li class="@if(request()->routeIs('admin.income*') || request()->routeIs('admin.irrincome*')) active mm-active  @endif">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li>
                            <a href="{{ route('admin.irrincome') }}" class=" waves-effect">
                                <i class="ti-money"></i>
                                <span>IrrRegular Income</span>
                            </a>
                        </li>
                ...
                <li class="@if(request()->routeIs('admin.irrexpanse*') || request()->routeIs('admin.expanse*')) active mm-active  @endif">
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="ti-email"></i>
                        <span>Expanse</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                            <a href="{{ route('admin.expanse') }}" class=" waves-effect">
                                <i class="ti-money"></i>
                                <span>Regular</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.irrexpanse') }}" class=" waves-effect">
                                <i class="ti-money"></i>
                                <span>IrrRegular</span>
                            </a>
                        </li>
                    </ul>
                </li>
...
{{--
                <li class="@if(request()->routeIs('admin.expanse*')) active mm-active  @endif">
                    <a href="{{ route('admin.expanse') }}" class=" waves-effect">
                        <i class="ti-money"></i>
                        <span>Regular Expanse</span>
                    </a>
                </li> --}}
{{--
                <li class="@if(request()->routeIs('admin.irrexpanse*')) active mm-active  @endif">
                    <a href="{{ route('admin.irrexpanse') }}" class=" waves-effect">
                        <i class="ti-money"></i>
                        <span>IrrRegular Expanse</span>
                    </a>
                </li> --}}

                <li class="@if(request()->routeIs('admin.product*')) active mm-active  @endif">
