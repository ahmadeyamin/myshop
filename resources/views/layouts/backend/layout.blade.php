                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <h2 class="text-white mt-3">ShopCap</h2>
                                </span>
                                <span class="logo-lg">
                                    <h2 class="text-white mt-3">ShopCap</h2>
                                </span>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                © <script>document.write(new Date().getFullYear())</script> Ahmad Eyamin<span class="d-none d-sm-inline-block"> - Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand.</span>
                            </div>
                        </div>
                    </div>
                </footer>
        ...
        {{-- <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    ...
                    <a href="about.me/ahmadeyamin" class="btn btn-primary btn-block mt-3" target="_blank"><i class="mdi mdi-cart mr-1"></i> Purchase Now</a>
...
<!-- Mirrored from themesbrand.com/veltrix/layouts/vertical/pages-blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2020 17:11:32 GMT -->
</html>
